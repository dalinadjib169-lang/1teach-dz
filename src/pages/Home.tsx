      ...
      const mockPosts: Post[] = [
        {
          ...
          authorPhoto: 'https://ui-avatars.com/api/?name=Ahmed+Mansour&background=random',
          content: 'السلام عليكم زملائي الكرام. هل لديكم مذكرات السنة الثالثة ثانوي لمادة الرياضيات؟',
          privacy: 'public',
          likes: ['demo-user-123'],
          commentCount: 5,
        ...
        },
        {
          ...
          authorPhoto: 'https://ui-avatars.com/api/?name=Fatima+Zohra&background=random',
          content: 'اليوم كان يوماً رائعاً مع تلاميذي في القسم. التفاعل كان ممتازاً!',
          privacy: 'public',
          likes: [],
          commentCount: 2,
          createdAt: Timestamp.now(),
