      ...
      <UploadProvider>
        <Router>
          <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-purple-500/30">
            {isPlaceholderConfig && (
              <div className="bg-amber-500 text-amber-950 px-4 py-1 text-[10px] font-black uppercase tracking-widest text-center sticky top-0 z-[100] shadow-lg">
                Demo Mode Active: Firebase not configured. Data is not saved.
              </div>
            )}
            {loading ? (
